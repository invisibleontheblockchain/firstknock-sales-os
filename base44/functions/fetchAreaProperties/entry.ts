...
Deno.serve(async (req) => {
    try {
        ...
        const activeJob = await findActivePrecisionJob(base44, user);
        if (activeJob) {
            ...
            const activeReservation = jobUsage(activeJob).reserved;
            ...
            const activeCriteria = buildExistingPrecisionCriteria(activeJob, {

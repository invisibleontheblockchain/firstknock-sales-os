...
Deno.serve(async (req) => {
    try {
        ...
        const propertyColumns = [
            ...
            ['fips_code', 'TEXT'],
            ['batchdata_property_id', 'TEXT'],
            ['listing_status', 'TEXT'],
            ['owner_occupied', 'BOOLEAN'],
            ['corporate_owned', 'BOOLEAN'],
            ['investor_owned', 'BOOLEAN'],
            ['last_sale_recording_date', 'TIMESTAMPTZ'],
            ['raw_payload', 'JSONB'],
        ...
        const indexStatements = [
            ...
            'CREATE INDEX IF NOT EXISTS idx_properties_batchdata_property_id ON properties(batchdata_property_id)',

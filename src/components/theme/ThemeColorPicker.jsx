    ...
    return (
        <div className="space-y-3">
            <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Accent Color</span>
            </div>
            <div className="flex flex-wrap gap-2">
                {colors.map(c => (
                    <button
                        ...
                        style={{
                            background: c.value,
                            boxShadow: accent === c.value ? `0 0 0 2px #0A0A0A, 0 0 0 4px ${c.value}` : 'none',
                        }}
                        title={c.name}
                    >

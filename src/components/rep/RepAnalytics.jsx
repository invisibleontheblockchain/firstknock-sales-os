...
export default function RepAnalytics({ logs, routeProperties, activeRoute, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-md flex flex-col pt-[env(safe-area-inset-top)]" onClick={onClose}>
            <div className="flex-1 overflow-y-auto" onClick={e => e.stopPropagation()}>
                ...
                <div className="sticky top-0 bg-black/95 backdrop-blur px-4 py-3 flex items-center justify-between border-b border-white/5 z-20">
                    ...
                    <button onClick={onClose} className="w-10 h-10 rounded-full bg-[#2EEB57] flex items-center justify-center active:scale-90 transition-all shadow-[0_4px_16px_rgba(46,235,87,0.3)] hover:bg-[#39FF4A]">

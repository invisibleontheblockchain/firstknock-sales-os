      ...
      <div className="flex h-screen flex-col items-center justify-center relative overflow-hidden bg-[#000000] text-white p-6 text-center">
          ...
          WebkitMaskImage: 'linear-gradient(to bottom, transparent, black, transparent)'
                ...
                <div className="relative z-10 flex flex-col items-center space-y-8 max-w-sm w-full">
                    <img src="https://media.base44.com/images/public/695eb764b077190880be21de/147abd69b_image.png" alt="FirstKnock Logo" className="w-20 h-20 rounded-2xl object-cover shadow-[0_0_40px_rgba(46,235,87,0.5)] border border-white/10" />
                ...
                <div className="flex items-center w-full h-16 pt-0">
                    <Link to="/" className="flex items-center mr-auto group shrink-0 text-white">
                        <span className="relative block h-12 w-[152px] overflow-hidden">
                            <img src="https://media.base44.com/images/public/695eb764b077190880be21de/80866e548_ChatGPTImageJul1202611_48_19AM.png" alt="FirstKnock" className="h-[102px] w-auto max-w-none -translate-x-2 md:translate-x-0 -translate-y-[23px] object-contain" />
                        </span>
                    </Link>

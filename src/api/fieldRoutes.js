...
const SAFE_ERROR_MESSAGES = Object.freeze({
  ...
  fieldroutes_not_configured: 'Save the FieldRoutes credentials before loading inspection services.',
  ...
  fieldroutes_office_scope_required: 'Use FieldRoutes credentials scoped to exactly one office, then reconnect.',
  ...
  provider_service_type_invalid: 'That service is not an eligible initial inspection service. Reload the services and choose another.',
  provider_multi_office_not_supported: 'These credentials cover multiple offices. Use an office-scoped FieldRoutes API key.',
